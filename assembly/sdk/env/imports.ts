...
@external("env", "sha256")
@global
declare function _sha256(value_len: u64, value_ptr: u64, register_id: u64) : void;
//@ts-ignore
@external("env", "keccak256")
@global
declare function _keccak256(value_len: u64, value_ptr: u64, register_id: u64) : void;
//@ts-ignore
@external("env", "keccak512")
@global
declare function _keccak512(value_len: u64, value_ptr: u64, register_id: u64) : void;
...
@global
declare function _promise_create(account_id_len: u64,account_id_ptr: u64,method_name_len: u64,method_name_ptr: u64,arguments_len: u64, arguments_ptr: u64, amount_ptr: u64, gas: u64) : u64;
//@ts-ignore
@external("env", "promise_then")
@global
declare function _promise_then( promise_index: u64, account_id_len: u64, account_id_ptr: u64, method_name_len: u64, method_name_ptr: u64, arguments_len: u64, arguments_ptr: u64, amount_ptr: u64, gas: u64 ) : u64;
//@ts-ignore
@external("env", "promise_and")
@global
declare function _promise_and(promise_idx_ptr: u64, promise_idx_count: u64) : u64;
//@ts-ignore
@external("env", "promise_batch_create")
@global
declare function _promise_batch_create(account_id_len: u64, account_id_ptr: u64): u64;
//@ts-ignore
@external("env", "promise_batch_then")
@global
declare function _promise_batch_then(promise_index: u64, account_id_len: u64, account_id_ptr: u64): u64;
...
@global
declare function _promise_batch_action_deploy_contract(promise_index: u64, code_len: u64, code_ptr: u64): void;
//@ts-ignore
@external("env", "promise_batch_action_function_call")
@global
declare function _promise_batch_action_function_call(promise_index: u64, method_name_len: u64, method_name_ptr: u64, arguments_len: u64, arguments_ptr: u64, amount_ptr: u64, gas: u64): void;
//@ts-ignore
@external("env", "promise_batch_action_transfer")
@global
declare function _promise_batch_action_transfer(promise_index: u64, amount_ptr: u64): void;
//@ts-ignore
@external("env", "promise_batch_action_stake")
@global
declare function _promise_batch_action_stake(promise_index: u64, amount_ptr: u64, public_key_len: u64, public_key_ptr: u64): void;
//@ts-ignore
@external("env", "promise_batch_action_add_key_with_full_access")
@global
declare function _promise_batch_action_add_key_with_full_access(promise_index: u64, public_key_len: u64, public_key_ptr: u64, nonce: u64): void;
//@ts-ignore
@external("env", "promise_batch_action_add_key_with_function_call")
@global
declare function _promise_batch_action_add_key_with_function_call(promise_index: u64, public_key_len: u64, public_key_ptr: u64, nonce: u64, allowance_ptr: u64, receiver_id_len: u64, receiver_id_ptr: u64, method_names_len: u64, method_names_ptr: u64): void;
//@ts-ignore
@external("env", "promise_batch_action_delete_key")
@global
declare function _promise_batch_action_delete_key(promise_index: u64, public_key_len: u64, public_key_ptr: u64): void;
//@ts-ignore
@external("env", "promise_batch_action_delete_account")
@global
declare function _promise_batch_action_delete_account(promise_index: u64, beneficiary_id_len: u64, beneficiary_id_ptr: u64): void
...
@global
declare function _storage_write(key_len: u64, key_ptr: u64, value_len: u64, value_ptr: u64, register_id: u64) : u64;
//@ts-ignore
@external("env", "storage_read")
@global
declare function _storage_read(key_len: u64, key_ptr: u64, register_id: u64) : u64;
//@ts-ignore
@external("env", "storage_remove")
@global
declare function _storage_remove(key_len: u64, key_ptr: u64, register_id: u64) : u64;
//@ts-ignore
